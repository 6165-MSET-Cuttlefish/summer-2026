...
import org.firstinspires.ftc.teamcode.purepursuit.messages.DriveCommandMessage;
import org.firstinspires.ftc.teamcode.purepursuit.messages.MecanumCommandMessage;
import org.firstinspires.ftc.teamcode.purepursuit.messages.MecanumLocalizerInputsMessage;
import org.firstinspires.ftc.teamcode.purepursuit.messages.PoseMessage;
...
@Config
public final class MecanumDrivePurePursuit {
    ...
    public class DriveLocalizer implements Localizer {
        ...
        public DriveLocalizer(Pose2d pose) {
            leftFront = new OverflowEncoder(new RawEncoder(MecanumDrivePurePursuit.this.leftFront));
            leftBack = new OverflowEncoder(new RawEncoder(MecanumDrivePurePursuit.this.leftBack));
            rightBack = new OverflowEncoder(new RawEncoder(MecanumDrivePurePursuit.this.rightBack));
            rightFront = new OverflowEncoder(new RawEncoder(MecanumDrivePurePursuit.this.rightFront));
    ...
    public MecanumDrivePurePursuit(HardwareMap hardwareMap, Pose2d pose) {
