...
public final class PedroSetup {
    ...
    public static FollowerConstants followerConstants =
            new FollowerConstants()
                    .mass(13.5)
                    .forwardZeroPowerAcceleration(-49.65)
                    ...
                    .drivePIDFCoefficients(new FilteredPIDFCoefficients(0.1,0,0.002,0.6,0.08))
                    .useSecondaryDrivePIDF(true)
                    .secondaryDrivePIDFCoefficients(new FilteredPIDFCoefficients(0.01,0,0.000000,0.6,0.0))
