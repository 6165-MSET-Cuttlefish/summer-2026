package org.firstinspires.ftc.teamcode.purepursuit.tuning;
...
//                    lazyImu = new OTOSIMU(ol.otos);
                if (md.localizer instanceof PinpointLocalizerPurePursuit) {
                ...
                return new DriveView(
                    DriveType.MECANUM,
                        MecanumDrivePurePursuit.PARAMS.inPerTick,
                        MecanumDrivePurePursuit.PARAMS.maxWheelVel,
                        MecanumDrivePurePursuit.PARAMS.minProfileAccel,
                        MecanumDrivePurePursuit.PARAMS.maxProfileAccel,
                        encoderGroups,
                        Arrays.asList(
                                md.leftFront,
                                md.leftBack
                        ...
                        lazyImu,
                        md.voltageSensor,
                        () -> new MotorFeedforward(MecanumDrivePurePursuit.PARAMS.kS,
                                MecanumDrivePurePursuit.PARAMS.kV / MecanumDrivePurePursuit.PARAMS.inPerTick,
                                MecanumDrivePurePursuit.PARAMS.kA / MecanumDrivePurePursuit.PARAMS.inPerTick),
                        0
                );
            };
