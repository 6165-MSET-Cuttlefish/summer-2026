 ...
 * ContextBlue selector opmodes run before the auto; the summer-2026 idiom folds the selection into a
 * thin {@link Close} subclass that pins {@link AllianceColor#RED} in {@code createRobot()} and runs
